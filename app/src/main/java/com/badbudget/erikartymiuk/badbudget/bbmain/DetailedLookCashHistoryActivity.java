...
/**
 * History for a single cash account. Based off of the detailed look general history. TODO 1/2/2017 comment
 */
public class DetailedLookCashHistoryActivity extends DetailedLookBaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ListView listView = (ListView)findViewById(R.id.detailedLookCashHistory);
        ...
        {
            FlavorSpecific.adRequest(this, R.layout.content_detailed_look_cash_history);
        }
    }
    ...
    protected void updateHistoryViews()
    {
        ...
        {
            Account currAccount = bbd.getAccountWithName(accountId);
